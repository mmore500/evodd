...
# that artifact's l2_scale=0.003 does NOT complement it exactly
# (0.9966 + 0.003 = 0.9996, not 1), unlike every other mix this project has
# swept, which all follow l2_scale = 1 - l1_scale. This script covers 3
