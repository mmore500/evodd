...
# doubles S1 specifically (--doubled-class 0, i.e. train_idx position 0
# -- see the notebook's "Training schedule" section, added for this
# follow-up); slurm/2026-07-31/2026-07-31-exploratory-edge-sparsity-doubled-s2.sh
# and -doubled-s3.sh are identical except for --doubled-class (1 and 2,
# doubling S2/S3 respectively).
#
